...
//   const WEBHOOK_SECRET = process.env.WEBHOOK_SECRET; // ✅ matches your .env/.env.local
...
//   // If somehow not a user id, skip
//   if (!userId || !userId.startsWith("user_")) {
//     console.log("Skipped (not a user id):", userId);
//     return new Response("Skipped (not a user id)", { status: 200 });
//   }

//   console.log(`Webhook type: ${evt.type} | userId: ${userId}`);

//   try {
//     // 1) Try from webhook payload first
//     let email: string | undefined;

//     const email_addresses = data?.email_addresses as
...
//     // 2) If payload doesn't include email, fetch from Clerk API (safe)
//     if (!email) {
...
//     console.log("User upserted:", { userId, email });
