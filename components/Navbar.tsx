...
//           <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-violet-500 to-cyan-400 p-[1px] shadow-[0_0_0_1px_rgba(255,255,255,.10)]">
...
//           {/* If you have an admin route, keep this link (won't break anything). */}
//           <Button
//             asChild
//             variant="ghost"
